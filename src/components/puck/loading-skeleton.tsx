    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 bg-background p-8">
          <div className="max-w-lg mx-auto bg-background rounded-lg shadow-sm border">
            <div className="p-6 space-y-4">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="space-y-2">
                  <div className="h-4 w-3/4 bg-muted rounded animate-pulse"></div>
                  <div className="h-4 w-1/2 bg-muted/70 rounded animate-pulse"></div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="w-64 border-l bg-background p-4">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="space-y-2">
                  <div className="h-4 w-16 bg-muted/70 rounded animate-pulse"></div>
